...
import top.zcw.control.app.BuildConfig;
import top.zcw.control.app.R;
import top.zcw.control.app.adb.Adb;
import top.zcw.control.app.buffer.BufferStream;
import top.zcw.control.app.client.decode.DecodecTools;
...
public class ClientStream {
  ...
  private void startServer(Device device) throws Exception {
    ...
    shell = adb.getShell();
    shell.write(ByteBuffer.wrap(("app_process -Djava.class.path=" + serverName + " / top.zcw.control.server.Server"
