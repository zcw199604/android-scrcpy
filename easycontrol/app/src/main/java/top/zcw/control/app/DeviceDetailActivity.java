...
import top.zcw.control.app.databinding.ActivityDeviceDetailBinding;
import top.zcw.control.app.databinding.ItemLoadingBinding;
import top.zcw.control.app.databinding.ItemScanAddressListBinding;
import top.zcw.control.app.databinding.ItemTextBinding;
...
public class DeviceDetailActivity extends Activity {
  ...
  private void drawUI() {
    ...
    if (device.isNetworkDevice()) activityDeviceDetailBinding.layoutOnConnectSub.addView(ViewTools.createSwitchCard(this, getString(R.string.device_force_adb_forward_on_connect), getString(R.string.device_force_adb_forward_on_connect_detail), device.forceAdbForwardOnConnect, isChecked -> device.forceAdbForwardOnConnect = isChecked).getRoot());
    activityDeviceDetailBinding.layoutOnConnectSub.addView(ViewTools.createSwitchCard(this, getString(R.string.device_use_app_key_on_connect), getString(R.string.device_use_app_key_on_connect_detail), device.useAppKey, isChecked -> device.useAppKey = isChecked).getRoot());
    // 运行时操作
