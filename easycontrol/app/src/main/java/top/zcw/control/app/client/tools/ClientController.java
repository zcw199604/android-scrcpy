...
import top.zcw.control.app.client.view.FullActivity;
import top.zcw.control.app.client.view.MiniView;
import top.zcw.control.app.client.view.SmallView;
...
public class ClientController implements TextureView.SurfaceTextureListener {
  ...
  private void handleAction(String action, ByteBuffer byteBuffer) {
    try {
      ...
      byte[] err = ("controller:" + AppData.applicationContext.getString(R.string.toast_stream_closed)).getBytes(StandardCharsets.UTF_8);
